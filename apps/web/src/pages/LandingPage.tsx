            ...
            <Grid size={{ xs: 12, lg: 6 }}>
              <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", gap: 2 }}>
                ...
                <Stack direction="row" spacing={1.5} sx={{ mt: 2, flexWrap: "wrap" }}>
                  ...
                  <Button variant="outlined" component={RouterLink} to="/dashboard" sx={{ outline: `1px solid ${tokens.colors.outlineVariant}`, color: tokens.colors.primary, px: 4, py: 1.5, borderRadius: tokens.shape.borderRadius.full, ...tokens.typography.labelMd, textTransform: "none", "&:hover": { bgcolor: alpha(tokens.colors.primary, 0.05), outline: `1px solid ${tokens.colors.outlineVariant}` }, transition: "all 0.2s" }}>
                    View Case Studies
                  </Button>
                </Stack>
              </Box>
